...
struct
  ...
  [ID("min", "fun"), ID("num", "num"), ID("question2", "roles"),
   ...
   ID("ind_type", "BOTTOM"), ID("question2", "Bank"),
   ID("question2", "CA"), ID("bool", "COND"), ID("ind_type", "CONSTR"),
   ID("question2", "Commander"), ID("bool", "DATATYPE"),
   ...
   ID("aclfoundation", "Form"), ID("question2", "go"),
   ID("aclfoundation", "impf"), ID("question2", "keyPrinc_CASE"),
   ID("question2", "keyPrinc_size"), ID("question2", "nogo"),
   ID("question2", "num2commands"), ID("question2", "num2people"),
   ID("question2", "num2roles"), ID("question2", "people2num"),
  ...
  [TYOP [1], TYOP [2], TYOP [0, 1, 0], TYV "'a", TYOP [0, 3, 3],
   ...
   TYOP [0, 37, 131], TYOP [0, 0, 132], TYOP [36, 7], TYOP [0, 7, 134],
   TYOP [0, 89, 113], TYOP [0, 89, 117], TYOP [0, 89, 123],
   TYOP [0, 41, 121], TYOP [0, 39, 115], TYOP [48, 19, 7, 43, 42],
  ...
  val _ = Theory.incorporate_consts "question2" tyvector
     [("roles_size", 2), ("roles_CASE", 6), ("roles2num", 2),
      ...
      ("num2people", 18), ("num2commands", 20), ("nogo", 19),
      ("keyPrinc_size", 21), ("keyPrinc_CASE", 28), ("go", 19),
      ("commands_size", 29), ("commands_CASE", 30), ("commands2num", 29),
      ("Staff", 31), ("Role", 32), ("PR", 33), ("Key", 33),
      ("Commander", 1), ("CA", 1), ("Bank", 14), ("Ap", 34),
      ("Alice", 14)];
  ...
  [TMV("'keyPrinc'", 39), TMV("'principals'", 41), TMV("M", 45),
   ...
   TMC(26, 38), TMC(27, 14), TMC(28, 1), TMC(29, 125), TMC(30, 129),
   TMC(30, 133), TMC(31, 1), TMC(32, 103), TMC(33, 33), TMC(34, 91),
   TMC(35, 135), TMC(37, 33), TMC(38, 32), TMC(39, 91), TMC(40, 31),
   TMC(41, 136), TMC(41, 137), TMC(41, 138), TMC(41, 139), TMC(41, 140),
   TMC(42, 0), TMC(43, 104), TMC(44, 29), TMC(45, 30), TMC(46, 29),
   TMC(47, 143), TMC(49, 19), TMC(50, 144), TMC(51, 28), TMC(52, 21),
  ...
  fun op commands_TY_DEF x = x
    ...
    ThmBind.DT(((("question2",0),
               ...
               [ThmBind.read"%119%63%155%54%105$0@%149%138%160@3|@$0@|@"])
  fun op commands_BIJ x = x
    val op commands_BIJ =
    ThmBind.DT(((("question2",1),
                [("bool",[116]),("question2",[0])]),["DISK_THM"]),
               [ThmBind.read"%103%79%21%108%171%162$0@3$0@|@2%92%60%107%54%105$0@%149%138%160@3|$0@2%110%162%171$0@3$0@2|@2"])


  fun op commands_size_def x = x
    val op commands_size_def =
    ThmBind.DT(((("question2",13),[]),[]),
               [ThmBind.read"%79%73%110%164$0@2%104@|@"])
  fun op commands_CASE x = x
    val op commands_CASE =
    ThmBind.DT(((("question2",14),[]),[]),
               [ThmBind.read"%79%73%78%69%78%71%106%163$2@$1@$0@2%53%143%110$0@%104@2$2@$1@|%162$2@3|@|@|@"])
  fun op people_TY_DEF x = x
    val op people_TY_DEF =
    ThmBind.DT(((("question2",22),
                [("bool",[25]),("numeral",[3,7])]),["DISK_THM"]),
               [ThmBind.read"%123%65%156%54%105$0@%149%138%160@3|@$0@|@"])
  fun op people_BIJ x = x
    val op people_BIJ =
    ThmBind.DT(((("question2",23),
                [("bool",[116]),("question2",[22])]),["DISK_THM"]),
               [ThmBind.read"%103%93%24%111%172%174$0@3$0@|@2%92%60%107%54%105$0@%149%138%160@3|$0@2%110%174%172$0@3$0@2|@2"])
  ...
  fun op people_CASE x = x
    ...
    ThmBind.DT(((("question2",36),[]),[]),
               [ThmBind.read"%93%74%78%69%78%71%106%175$2@$1@$0@2%53%143%110$0@%104@2$2@$1@|%174$2@3|@|@|@"])
  fun op roles_TY_DEF x = x
    val op roles_TY_DEF =
    ThmBind.DT(((("question2",44),
                [("bool",[25]),("numeral",[3,7])]),["DISK_THM"]),
               [ThmBind.read"%127%67%157%54%105$0@%149%138%160@3|@$0@|@"])
  fun op roles_BIJ x = x
    val op roles_BIJ =
    ThmBind.DT(((("question2",45),
                [("bool",[116]),("question2",[44])]),["DISK_THM"]),
               [ThmBind.read"%103%97%25%115%173%182$0@3$0@|@2%92%60%107%54%105$0@%149%138%160@3|$0@2%110%182%173$0@3$0@2|@2"])
  ...
  fun op roles_CASE x = x
    ...
    ThmBind.DT(((("question2",58),[]),[]),
               [ThmBind.read"%97%75%78%69%78%71%106%183$2@$1@$0@2%53%143%110$0@%104@2$2@$1@|%182$2@3|@|@|@"])
  fun op keyPrinc_TY_DEF x = x
    val op keyPrinc_TY_DEF =
    ThmBind.DT(((("question2",66),[("bool",[26])]),["DISK_THM"]),
               [ThmBind.read"%121%64%159%32%88%0%116%96%32%116%161%130%24%114$1@%24%145%104@%100$0@%102%134@%132@3%54%140|@|$0@2|@2%161%131%25%114$1@%25%145%153%104@2%100%133@%102$0@%132@3%54%140|@|$0@2|@2%129%23%114$1@%23%145%153%153%104@3%100%133@%102%134@$0@3%54%140|@|$0@2|@4$1$0@2|@2$0$1@2|@|@$0@|@"])
  fun op keyPrinc_case_def x = x
    ...
    ThmBind.DT(((("question2",74),
               ...
               [ThmBind.read"%103%93%24%84%36%89%43%83%46%106%168%154$3@2$2@$1@$0@2$2$3@2|@|@|@|@2%103%97%25%84%36%89%43%83%46%106%168%152$3@2$2@$1@$0@2$1$3@2|@|@|@|@2%92%23%84%36%89%43%83%46%106%168%136$3@2$2@$1@$0@2$0$3@2|@|@|@|@3"])
  fun op keyPrinc_size_def x = x
    val op keyPrinc_size_def =
    ThmBind.DT(((("question2",75),
                [("bool",[26,180]),("ind_type",[33,34]),("pair",[8,9]),
                 ("question2",[67,68,69,70,71,72,73])]),["DISK_THM"]),
               [ThmBind.read"%103%93%24%110%169%154$0@3%98%149%137%160@3%176$0@3|@2%103%97%25%110%169%152$0@3%98%149%137%160@3%184$0@3|@2%92%23%110%169%136$0@3%98%149%137%160@3$0@2|@3"])
  fun op principals_TY_DEF x = x
    val op principals_TY_DEF =
    ThmBind.DT(((("question2",83),[("bool",[26])]),["DISK_THM"]),
               [ThmBind.read"%125%66%158%31%87%1%116%95%31%116%161%128%22%113$1@%22%144%104@$0@%54%139|@|$0@2|@2%128%22%113$1@%22%144%153%104@2$0@%54%139|@|$0@2|@3$1$0@2|@2$0$1@2|@|@$0@|@"])
  ...
  fun op commands_case_cong x = x
    ...
    ThmBind.DT(((("question2",18),
               ...
               [ThmBind.read"%79%3%79%8%78%69%78%71%116%103%108$3@$2@2%103%116%108$2@%166@2%106$1@%70@3%116%108$2@%170@2%106$0@%72@5%106%163$3@$1@$0@2%163$2@%70@%72@3|@|@|@|@"])
  ...
  fun op num2people_ONTO x = x
    ...
    ThmBind.DT(((("question2",28),
               ...
               [ThmBind.read"%93%24%129%60%103%111$1@%172$0@3%105$0@%149%138%160@4|@|@"])
  fun op people2num_ONTO x = x
    val op people2num_ONTO =
    ThmBind.DT(((("question2",29),
                [("bool",[26]),("question2",[23])]),["DISK_THM"]),
               [ThmBind.read"%92%60%107%105$0@%149%138%160@4%130%24%110$1@%174$0@2|@2|@"])
  fun op num2people_thm x = x
    val op num2people_thm =
    ThmBind.DT(((("question2",32),[("question2",[30,31])]),[]),
               [ThmBind.read"%103%111%172%104@2%135@2%111%172%149%137%160@4%141@2"])
  fun op people2num_thm x = x
    val op people2num_thm =
    ThmBind.DT(((("question2",33),
                [("bool",[25,53]),("numeral",[3,7]),
                 ("question2",[25,30,31])]),["DISK_THM"]),
               [ThmBind.read"%103%110%174%135@2%104@2%110%174%141@2%149%137%160@4"])
  ...
  fun op people_nchotomy x = x
    ...
    ThmBind.DT(((("question2",41),
                [("arithmetic",
                 ...
                 ("question2",[28,30,31]),
                 ("sat",[1,3,5,6,7,11,12,13,15])]),["DISK_THM"]),
               [ThmBind.read"%93%24%161%111$0@%135@2%111$0@%141@2|@"])
  ...
  fun op num2roles_roles2num x = x
    ...
    ThmBind.DT(((("question2",46),[("question2",[45])]),["DISK_THM"]),
               [ThmBind.read"%97%25%115%173%182$0@3$0@|@"])
  fun op roles2num_num2roles x = x
    val op roles2num_num2roles =
    ThmBind.DT(((("question2",47),[("question2",[45])]),["DISK_THM"]),
               [ThmBind.read"%92%60%107%105$0@%149%138%160@4%110%182%173$0@3$0@2|@"])
  fun op num2roles_11 x = x
    val op num2roles_11 =
    ThmBind.DT(((("question2",48),
                [("bool",[26]),("question2",[45])]),["DISK_THM"]),
               [ThmBind.read"%92%60%92%62%116%105$1@%149%138%160@4%116%105$0@%149%138%160@4%107%115%173$1@2%173$0@3%110$1@$0@4|@|@"])
  ...
  fun op num2roles_ONTO x = x
    ...
    ThmBind.DT(((("question2",50),
               ...
               [ThmBind.read"%97%25%129%60%103%115$1@%173$0@3%105$0@%149%138%160@4|@|@"])
  fun op roles2num_ONTO x = x
    val op roles2num_ONTO =
    ThmBind.DT(((("question2",51),
                [("bool",[26]),("question2",[45])]),["DISK_THM"]),
               [ThmBind.read"%92%60%107%105$0@%149%138%160@4%131%25%110$1@%182$0@2|@2|@"])
  fun op num2roles_thm x = x
    val op num2roles_thm =
    ThmBind.DT(((("question2",54),[("question2",[52,53])]),[]),
               [ThmBind.read"%103%115%173%104@2%146@2%115%173%149%137%160@4%142@2"])
  fun op roles2num_thm x = x
    val op roles2num_thm =
    ThmBind.DT(((("question2",55),
                [("bool",[25,53]),("numeral",[3,7]),
                 ("question2",[47,52,53])]),["DISK_THM"]),
               [ThmBind.read"%103%110%182%146@2%104@2%110%182%142@2%149%137%160@4"])
  ...
  fun op roles_case_cong x = x
    ...
    ThmBind.DT(((("question2",62),
                [("arithmetic",
                 ...
                 ("sat",[1,3,5,6,7,11,12,13,15])]),["DISK_THM"]),
               [ThmBind.read"%97%7%97%12%78%69%78%71%116%103%115$3@$2@2%103%116%115$2@%146@2%106$1@%70@3%116%115$2@%142@2%106$0@%72@5%106%183$3@$1@$0@2%183$2@%70@%72@3|@|@|@|@"])
  fun op roles_nchotomy x = x
    ...
    ThmBind.DT(((("question2",63),
                [("arithmetic",
                 ...
                 ("question2",[50,52,53]),
                 ("sat",[1,3,5,6,7,11,12,13,15])]),["DISK_THM"]),
               [ThmBind.read"%97%25%161%115$0@%146@2%115$0@%142@2|@"])
  fun op roles_Axiom x = x
    val op roles_Axiom =
    ThmBind.DT(((("question2",64),
                [("bool",[8,14,25,55,63]),("numeral",[3,8]),
                 ("question2",[55])]),["DISK_THM"]),
               [ThmBind.read"%78%76%78%77%126%37%103%106$0%146@2$2@2%106$0%142@2$1@2|@|@|@"])
  ...
  fun op keyPrinc_11 x = x
    ...
    ThmBind.DT(((("question2",77),
                [("bool",[26,55,62,180]),("ind_type",[33,34]),
                 ("pair",[8,9]),
                 ("question2",[67,68,69,70,71,72,73])]),["DISK_THM"]),
               [ThmBind.read"%103%93%24%93%29%107%109%154$1@2%154$0@3%111$1@$0@2|@|@2%103%97%25%97%30%107%109%152$1@2%152$0@3%115$1@$0@2|@|@2%92%23%92%28%107%109%136$1@2%136$0@3%110$1@$0@2|@|@3"])
  fun op keyPrinc_distinct x = x
    ...
    ThmBind.DT(((("question2",78),
                [("bool",[25,26,35,46,50,53,55,62,180]),
                 ...
                 ("question2",[67,68,69,70,71,72,73])]),["DISK_THM"]),
               [ThmBind.read"%103%97%30%93%24%188%109%154$0@2%152$1@3|@|@2%103%92%28%93%24%188%109%154$0@2%136$1@3|@|@2%92%28%97%25%188%109%152$0@2%136$1@3|@|@3"])
  fun op keyPrinc_case_cong x = x
    val op keyPrinc_case_cong =
    ThmBind.DT(((("question2",79),
                [("bool",[26,180]),
                 ("question2",[67,68,69,70,71,72,73,74])]),["DISK_THM"]),
               [ThmBind.read"%91%4%91%9%84%36%89%43%83%46%116%103%109$4@$3@2%103%93%24%116%109$4@%154$0@3%106$3$0@2%39$0@3|@2%103%97%25%116%109$4@%152$0@3%106$2$0@2%45$0@3|@2%92%23%116%109$4@%136$0@3%106$1$0@2%47$0@3|@5%106%168$4@$2@$1@$0@2%168$3@%39@%45@%47@3|@|@|@|@|@"])
  fun op keyPrinc_nchotomy x = x
    val op keyPrinc_nchotomy =
    ThmBind.DT(((("question2",80),
                [("bool",[26,180]),
                 ("question2",[67,68,69,70,71,72,73])]),["DISK_THM"]),
               [ThmBind.read"%91%52%161%130%55%109$1@%154$0@2|@2%161%131%61%109$1@%152$0@2|@2%129%54%109$1@%136$0@2|@3|@"])
  fun op keyPrinc_Axiom x = x
    val op keyPrinc_Axiom =
    ThmBind.DT(((("question2",81),
                [("bool",[26,180]),("ind_type",[33,34]),("pair",[8,9]),
                 ("question2",[67,68,69,70,71,72,73])]),["DISK_THM"]),
               [ThmBind.read"%84%41%89%43%83%46%120%48%103%93%24%106$1%154$0@3$4$0@2|@2%103%97%25%106$1%152$0@3$3$0@2|@2%92%23%106$1%136$0@3$2$0@2|@3|@|@|@|@"])
  fun op keyPrinc_induction x = x
    val op keyPrinc_induction =
    ThmBind.DT(((("question2",82),
                [("bool",[26]),
                 ("question2",[67,68,69,70,71,72,73])]),["DISK_THM"]),
               [ThmBind.read"%82%17%116%103%93%55$1%154$0@2|@2%103%97%61$1%152$0@2|@2%92%54$1%136$0@2|@4%91%50$1$0@|@2|@"])
  fun op datatype_principals x = x
    val op datatype_principals =
    ThmBind.DT(((("question2",91),[("bool",[25,170])]),["DISK_THM"]),
               [ThmBind.read"%147%59%151@%148@2"])
  fun op principals_11 x = x
    val op principals_11 =
    ThmBind.DT(((("question2",92),
                [("bool",[26,55,62,180]),("ind_type",[33,34]),
                 ("question2",[84,85,86,87,88])]),["DISK_THM"]),
               [ThmBind.read"%103%91%22%91%27%107%112%151$1@2%151$0@3%109$1@$0@2|@|@2%91%22%91%27%107%112%148$1@2%148$0@3%109$1@$0@2|@|@2"])
  fun op principals_distinct x = x
    val op principals_distinct =
    ThmBind.DT(((("question2",93),
                [("bool",[25,26,46,53,62,180]),("ind_type",[33,34]),
                 ("question2",[84,85,86,87,88])]),["DISK_THM"]),
               [ThmBind.read"%91%27%91%22%188%112%151$0@2%148$1@3|@|@"])
  fun op principals_case_cong x = x
    val op principals_case_cong =
    ThmBind.DT(((("question2",94),
                [("bool",[26,180]),
                 ("question2",[84,85,86,87,88,89])]),["DISK_THM"]),
               [ThmBind.read"%94%6%94%11%81%35%81%42%116%103%112$3@$2@2%103%91%22%116%112$3@%151$0@3%106$2$0@2%38$0@3|@2%91%22%116%112$3@%148$0@3%106$1$0@2%44$0@3|@4%106%177$3@$1@$0@2%177$2@%38@%44@3|@|@|@|@"])
  fun op principals_nchotomy x = x
    val op principals_nchotomy =
    ThmBind.DT(((("question2",95),
                [("bool",[26,180]),
                 ("question2",[84,85,86,87,88])]),["DISK_THM"]),
               [ThmBind.read"%94%58%161%128%50%112$1@%151$0@2|@2%128%50%112$1@%148$0@2|@2|@"])
  fun op principals_Axiom x = x
    val op principals_Axiom =
    ThmBind.DT(((("question2",96),
                [("bool",[26,180]),("ind_type",[33,34]),
                 ("question2",[84,85,86,87,88])]),["DISK_THM"]),
               [ThmBind.read"%81%40%81%42%124%49%103%91%22%106$1%151$0@3$3$0@2|@2%91%22%106$1%148$0@3$2$0@2|@2|@|@|@"])
  fun op principals_induction x = x
    val op principals_induction =
    ThmBind.DT(((("question2",97),
                [("bool",[26]),
                 ("question2",[84,85,86,87,88])]),["DISK_THM"]),
               [ThmBind.read"%86%19%116%103%91%50$1%151$0@2|@2%91%50$1%148$0@2|@3%94%56$1$0@|@2|@"])
  fun op question2Thm x = x
    val op question2Thm =
    ThmBind.DT(((("question2",98),
                [("aclDrules",[3,4,16]),
                 ("aclrules",[23,24,32,33])]),["DISK_THM"]),
               [ThmBind.read"%116%185%99%2@%101%13@%15@3%165%150%151%152%146@4%179%166@4%116%185%99%2@%101%13@%15@3%181%150%151%154%135@4%150%151%152%146@4%179%166@4%116%185%99%2@%101%13@%15@3%186%180%150%148%154%135@4%150%151%152%146@5%179%166@4%116%185%99%2@%101%13@%15@3%167%179%166@2%179%170@4%116%185%99%2@%101%13@%15@3%187%150%148%152%142@4%150%151%152%142@6%116%185%99%2@%101%13@%15@3%186%150%148%152%142@4%187%150%148%154%135@4%150%151%154%135@7%116%185%99%2@%101%13@%15@3%165%150%151%152%142@4%187%150%148%154%135@4%150%151%154%135@7%185%99%2@%101%13@%15@3%186%180%150%148%154%141@4%150%151%152%14@5%179%170@10"])
  ...
  val _ = Theory.LoadableThyData.temp_encoded_update {
    ...
    read = ThmBind.read,
    data =
        "OO12.commands2num4.%162OO12.num2commands4.%171OO2.go4.%166OO4.nogo4.%170OO13.commands_size4.%164OO13.commands_CASE4.%163OO4.case4.%163OO10.people2num4.%174OO10.num2people4.%172OO5.Alice4.%135OO4.Bank4.%141OO11.people_size4.%176OO11.people_CASE4.%175OO4.case4.%175OO9.roles2num4.%182OO9.num2roles4.%173OO9.Commander4.%146OO2.CA4.%142OO10.roles_size4.%184OO10.roles_CASE4.%183OO4.case4.%183OO5.Staff4.%154OO4.Role4.%152OO2.Ap4.%136OO13.keyPrinc_CASE4.%168OO13.keyPrinc_size4.%169OO4.case4.%168OO2.PR4.%151OO3.Key4.%148OO15.principals_CASE4.%177OO15.principals_size4.%178OO4.case4.%177"
  }
