...
Definitions:
    ...
    roles_CASE
      |- ∀x v0 v1.
           (case x of owner => v0 | requester => v1) =
...
Theorems:
    ...
    commands2num_thm
      |- (commands2num grant = 0) ∧ (commands2num deny = 1)
    commands_Axiom
      |- ∀x0 x1. ∃f. (f grant = x0) ∧ (f deny = x1)
    ...
    commands_case_cong
      |- ∀M M' v0 v1.
           (M = M') ∧ ((M' = grant) ⇒ (v0 = v0')) ∧
           ((M' = deny) ⇒ (v1 = v1')) ⇒
           ((case M of grant => v0 | deny => v1) =
            case M' of grant => v0' | deny => v1')
    commands_case_def
      |- (∀v0 v1. (case grant of grant => v0 | deny => v1) = v0) ∧
         ∀v0 v1. (case deny of grant => v0 | deny => v1) = v1
    commands_distinct
      |- grant ≠ deny
    commands_induction
      |- ∀P. P deny ∧ P grant ⇒ ∀a. P a
    commands_nchotomy
      |- ∀a. (a = grant) ∨ (a = deny)
    datatype_commands
      |- DATATYPE (commands grant deny)
    datatype_keyPrinc
      |- DATATYPE (keyPrinc Staff Role Ap)
    datatype_people
      |- DATATYPE (people Eve Bob)
    datatype_principals
      |- DATATYPE (principals PR Key)
    datatype_roles
      |- DATATYPE (roles owner requester)
    keyPrinc_11
    ...
    num2commands_commands2num
      |- ∀a. num2commands (commands2num a) = a
    num2commands_thm
      |- (num2commands 0 = grant) ∧ (num2commands 1 = deny)
    num2people_11
      |- ∀r r'.
    ...
    num2people_people2num
      |- ∀a. num2people (people2num a) = a
    num2people_thm
      |- (num2people 0 = Eve) ∧ (num2people 1 = Bob)
    num2roles_11
      |- ∀r r'.
    ...
    num2roles_roles2num
      |- ∀a. num2roles (roles2num a) = a
    num2roles_thm
      |- (num2roles 0 = owner) ∧ (num2roles 1 = requester)
    people2num_11
    ...
    people2num_thm
      |- (people2num Eve = 0) ∧ (people2num Bob = 1)
    people_Axiom
      |- ∀x0 x1. ∃f. (f Eve = x0) ∧ (f Bob = x1)
    people_EQ_people
    ...
    people_case_cong
      |- ∀M M' v0 v1.
           (M = M') ∧ ((M' = Eve) ⇒ (v0 = v0')) ∧
           ((M' = Bob) ⇒ (v1 = v1')) ⇒
           ((case M of Eve => v0 | Bob => v1) =
            case M' of Eve => v0' | Bob => v1')
    people_case_def
      |- (∀v0 v1. (case Eve of Eve => v0 | Bob => v1) = v0) ∧
         ∀v0 v1. (case Bob of Eve => v0 | Bob => v1) = v1
    people_distinct
      |- Eve ≠ Bob
    people_induction
      |- ∀P. P Bob ∧ P Eve ⇒ ∀a. P a
    ...
    question2Thm
      |- (M,Oi,Os) sat Name (PR (Role owner)) controls prop grant ⇒
         (M,Oi,Os) sat
         reps (Name (PR (Staff Eve))) (Name (PR (Role owner)))
           (prop grant) ⇒
         (M,Oi,Os) sat
         ...
         (M,Oi,Os) sat
         Name (Key (Role requester)) speaks_for
         Name (PR (Role requester)) ⇒
         (M,Oi,Os) sat
    ...
    roles2num_thm
      |- (roles2num owner = 0) ∧ (roles2num requester = 1)
    roles_Axiom
      |- ∀x0 x1. ∃f. (f owner = x0) ∧ (f requester = x1)
    roles_EQ_roles
    ...
    roles_case_cong
      |- ∀M M' v0 v1.
           (M = M') ∧ ((M' = owner) ⇒ (v0 = v0')) ∧
           ((M' = requester) ⇒ (v1 = v1')) ⇒
           ((case M of owner => v0 | requester => v1) =
            case M' of owner => v0' | requester => v1')
    roles_case_def
      |- (∀v0 v1. (case owner of owner => v0 | requester => v1) = v0) ∧
         ∀v0 v1. (case requester of owner => v0 | requester => v1) = v1
    roles_distinct
      |- owner ≠ requester
    roles_induction
      |- ∀P. P owner ∧ P requester ⇒ ∀a. P a
    roles_nchotomy
      |- ∀a. (a = owner) ∨ (a = requester)
Exporting theory "question2" ... done.
Theory "question2" took 0.22758s to build
